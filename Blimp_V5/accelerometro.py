...
if __name__ == "__main__":
    ...
    while  1:
        ...
        if (time.perf_counter() - time_start) >= 0.5:
            ...
            # Provo a usare codice per ruotare nel sistema di riferimento della stanza l'accelerometro
            angles = [roll, pitch, yaw]
            acc_UWB, gyro_UWB = rotation_UWB(accelerometer_UWB, gyroscope_UWB, angles)
            ...
            print( "Accelerometro ruotato = ", acc_UWB)
