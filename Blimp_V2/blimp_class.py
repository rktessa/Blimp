...
class Madgwick:
    ...
    beta = 0.35 # Questo è il nuovo beta usato per far funzionare meglio il Madgwick. valori di stabilità oscillano sui 3 gradi 
    zeta = 0
...
class PID_Controller:
    ...
    # Se il signal è 12, la forza è 12 N e voglio una PWM di 100
    def pwm_z_motor(self, force_z):
        m_coefficient = 100/12 #  da specificare per ogni motore
